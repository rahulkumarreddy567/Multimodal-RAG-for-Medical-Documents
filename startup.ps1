...
Start-Process powershell -ArgumentList "-NoExit", "-Command", ".\venv\Scripts\activate; uvicorn api.main:app --host 0.0.0.0 --port 8000 --reload"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", ".\venv\Scripts\activate; python -m ui.app"

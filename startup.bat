...
start "API Backend" cmd /k ".\venv\Scripts\python.exe -m uvicorn api.main:app --host 0.0.0.0 --port 8000 --reload"
...
start "Gradio UI" cmd /k ".\venv\Scripts\python.exe -m ui.app"
